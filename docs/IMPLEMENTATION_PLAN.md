...
https://quetzal.deployhost.workers.dev on 2026-09-08 (Worker renamed from
quetzal-playtest, then account subdomain changed from rikcroy to customsite to deployhost).
