...
The production Worker is `quetzal`. Cloudflare Workers Builds should watch
...
inputs from `quetzal-assets.rikcroy.workers.dev`, validate their sizes and SHA-256
